...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const inputStyles =
    "mb-4 block w-full rounded border border-gray-300 px-3 py-2 shadow-sm transition-colors focus:outline-none dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:ring-1 dark:focus:ring-blue-400";
